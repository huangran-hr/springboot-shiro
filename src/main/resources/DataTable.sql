...
CREATE TABLE `admin_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `path` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '与 Vue 路由中的 path 对应，即地址路径',
  `name` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '与 Vue 路由中的 name 属性对应',
  `name_zh` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '中文名称，用于渲染导航栏（菜单）界面',
  `icon_cls` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'element 图标类名，用于渲染菜单名称前的小图标',
  `component` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '组件名，用于解析路由对应的组件',
...
CREATE TABLE `admin_permission` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '权限的名称，推荐使用英文',
  `desc` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '权限功能的具体描述',
  `url` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '权限对应的接口，是实现功能控制的关键',
  PRIMARY KEY (`id`)
...
INSERT INTO `admin_role` VALUES (3, 'visitor', '访客');
INSERT INTO `admin_role` VALUES (4, 'test', '测试角色');

INSERT INTO `admin_user_role` VALUES (1, 4, 1);
INSERT INTO `admin_user_role` VALUES (2, 3, 4);
INSERT INTO `admin_user_role` VALUES (3, 5, 2);
...
INSERT INTO `admin_menu` VALUES (3, '/admin/user', 'User', '用户管理', 'el-icon-user', 'AdminIndex', 0);
INSERT INTO `admin_menu` VALUES (4, '/admin/content', 'Content', '内容管理', 'el-icon-tickets', 'AdminIndex', 0);
INSERT INTO `admin_menu` VALUES (5, '/admin/system', 'System', '系统配置', 'el-icon-s-tools', 'AdminIndex', 0);
...
INSERT INTO `admin_role_menu` VALUES (8, 1, 8);
INSERT INTO `admin_role_menu` VALUES (9, 1, 9);
INSERT INTO `admin_role_menu` VALUES (10, 1, 10);
INSERT INTO `admin_role_menu` VALUES (11, 2, 4);
INSERT INTO `admin_role_menu` VALUES (12, 2, 8);
INSERT INTO `admin_role_menu` VALUES (13, 2, 9);
INSERT INTO `admin_role_menu` VALUES (14, 2, 10);
INSERT INTO `admin_role_menu` VALUES (15, 4, 6);
INSERT INTO `admin_role_menu` VALUES (16, 4, 7);
INSERT INTO `admin_role_menu` VALUES (17, 4, 3);
INSERT INTO `admin_role_menu` VALUES (18, 2, 1);
...
INSERT INTO `admin_role_permission` VALUES (4, 2, 3);
INSERT INTO `admin_role_permission` VALUES (5, 4, 3);
...
INSERT INTO `book` VALUES (103, 'https://i.loli.net/2019/04/10/5cada940e206a.jpg', 'lallalalallala', 'lallaa', '1992-2', '北京', 'https://i.loli.net/2019/04/10/5cada940e206a.jpghttps://i.loli.net/2019/04/10/5cada940e206a.jpghttps://i.loli.net/2019/04/10/5cada940e206a.jpg', NULL);
